 ...
 * @author Pedro
 */
public class TelaCadastrarVinho extends javax.swing.JFrame {
    private ControladorVinho owner;
    
    
    public TelaCadastrarVinho(ControladorVinho owner) {
        this.owner = owner;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wine Control - Cadastro Vinho");
    ...
    private void botaoCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastroActionPerformed
        ...
        if(!camposObrigatoriosPreenchidos()){
          ...
          owner.cadastraVinho(campoNome.getText(),campoTipo.getText(),peso,campoDescrição.getText(),valor);
      }
